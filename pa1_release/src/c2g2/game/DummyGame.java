...
public class DummyGame implements IGameLogic {
    ...
    public void init(Window window) throws Exception {
        ...
        Mesh mesh = OBJLoader.loadMesh("src/resources/models/pokeball.obj");
        Mesh mesh2 = OBJLoader.loadMesh("src/resources/models/P2_CharizardWP.obj");
        Mesh mesh3 = OBJLoader.loadMesh("src/resources/models/trainer.obj");
        mesh.scaleMesh(0.002f, 0.002f, 0.002f);
        mesh2.scaleMesh(0.05f, 0.05f, 0.05f);
        mesh3.scaleMesh(0.05f, 0.05f, 0.05f);
        
        
        /*
        mesh.scaleMesh(0.25f, 0.25f, 0.25f);
        
        Vector3f a = new Vector3f(0.5f,0.5f,0.5f);
        Vector3f v = new Vector3f(0f,0f,1f);
        mesh.rotateMesh(v, 0.5f);
        
        Vector3f b = new Vector3f(0f, -1f, 0f);
        mesh.reflectMesh(a,b);
        */
        //Vector3f v = new Vector3f(0.5f,0.5f,0.5f);
        //mesh.translateMesh(v);
        
        
        //Mesh mesh = new Mesh();   comment this line when you enable OBJLoader
        Material material = new Material(new Vector3f(0.2f, 0.5f, 0.5f), reflectance);
        Material material2 = new Material(new Vector3f(0.2f, 0.5f, 0.5f), reflectance);
        Material material3 = new Material(new Vector3f(0.2f, 0.5f, 0.5f), reflectance);
       ...
       gameItem.setPosition(0.4f, 0, -2);
       gameItem2.setPosition(-0.7f, -0.4f, -2);
       gameItem3.setPosition(1f, -0.4f, -2);
    ...
    public void input(Window window, MouseInput mouseInput) {
    	...
    	*/
    		...
    		//rotation by manipulating mesh
    		gameItems[currentObj+2].getMesh().rotateMesh(new Vector3f(-0.5f,-0.5f,-0.5f), 0.15f);
    	}
    		...
    		//rotation by manipulating mesh
    		gameItems[currentObj+1].getMesh().rotateMesh(new Vector3f(0.5f,0.5f,0.5f), 0.2f);
    	}
    	else if(window.isKeyPressed(GLFW_KEY_2)){
    		//rotation by manipulating mesh
    		gameItems[currentObj].getMesh().scaleMesh(0.98f,0.98f,0.98f);
    	}
    		...
    		//rotation by manipulating mesh
    		gameItems[currentObj+1].getMesh().scaleMesh(0.98f,0.98f,0.98f);
    	}
    	else if(window.isKeyPressed(GLFW_KEY_5)){
    		//rotation by manipulating mesh
    		gameItems[currentObj+1].getMesh().scaleMesh(1.05f,1.05f,1.05f);
    	}
    	else if(window.isKeyPressed(GLFW_KEY_B)){
    		//move object x by step
    		Vector3f curr = gameItems[currentObj+1].getPosition();
    		gameItems[currentObj+1].setPosition(curr.x+TRANSLATE_STEP, curr.y, curr.z);
    	}
    		...
    		//move object y by step
    		Vector3f curr = gameItems[currentObj+1].getPosition();
    		gameItems[currentObj+1].setPosition(curr.x, curr.y+TRANSLATE_STEP, curr.z);
    	}
